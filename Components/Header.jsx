...
const Header = () => {
  return (
    <div className='py-5 px-5 md:px-6 lg:px-28'>
      <div className='flex justify-between items-center'>
        ...
        <div className='text-center my-8'>
            ...
            <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae cumque dignissimos ea explicabo ipsa nulla placeat porro quos unde ut. Aliquam delectus fuga ipsum itaque neque quae sapiente veniam? Itaque?</p>
